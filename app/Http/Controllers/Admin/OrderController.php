 ...
 * 
 * Purpose: Core order management system (Listing, Viewing, Processing, Fulfillment).
 * 
 * Data Flow: 
 * - Fetching: Retrieves complex order data with relations (Customer, Items, Payments).
 * - Updates: Handles status transitions (Pending -> Confirmed -> Shipped -> Delivered).
 * - Fulfillment: Updates tracking info and initiates shipments.
 * - Export: Generates CSV exports for external logistics processing.
 * 
 * Database: 
 * - `orders`: Primary order data.
 * - `order_items`: Line items for each order.
 * - `payments`: Transaction records.
 * - `shipments`: Fulfillment and tracking data.
 * - `order_status_history`: Audit trail for status changes.
 * 
 * Dependencies: DB Facade, Log Facade, Carbon.
 */
