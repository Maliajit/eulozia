...
class ProductController extends Controller
{
    ...
    public function listing(Request $request)
    {
        try {
            ...
            // Handle category slug from URL (e.g. ?category=slug)
            if (!$categoryId && $request->has('category')) {
                ...
                // If it's an array (from checkboxes), we take the first one for the title
                $firstId = is_array($categoryId) ? $categoryId[0] : $categoryId;
                $category = Category::find($firstId);
                if ($category) {
                    $categoryName = $category->name;
                }
            }
            ...
            return view('customer.products.listing', [
                ...
                'title' => ($categoryName !== 'All' ? $categoryName . ' - ' : 'All Products - ') . 'EULOZIA Collection',
            ]);
    ...
    public function category($slug, Request $request)
    {
        try {
            ...
            return view('customer.products.category', [
                ...
                'brandId' => $filters['brand_id'],
                'inStock' => $filters['in_stock'],
                'title' => $category->name . ' - EULOZIA Collection',
    ...
    public function details($slug)
    {
        try {
            ...
            return view('customer.products.details', [
                ...
                'reviews' => $reviews,
                'title' => $product['name'] . ' - EULOZIA Collection',
    ...
    public function search(Request $request)
    {
        try {
            ...
            return view('customer.products.search', [
                ...
                'brandId' => $filters['brand_id'],
                'inStock' => $filters['in_stock'],
                'title' => 'Search: ' . $searchQuery . ' - EULOZIA Collection',
                'meta_description' => 'Search results for ' . $searchQuery . ' in EULOZIA Collection',
            ]);
