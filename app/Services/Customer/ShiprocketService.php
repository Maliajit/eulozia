...
class ShiprocketService
{
    ...
    {
        // Does not require full credentials usually, but good to check if baseUrl is set
        // However, the base class ensureConfigured checks email/password.
        // Let's just allow it if we want, but for now let's be strict or add a baseUrl check.
        try {
