...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'auth.guards.admin_api.driver' => 'string',
            'auth.guards.admin_api.provider' => 'string',
            'auth.guards.customer_api.driver' => 'string',
            'auth.guards.customer_api.provider' => 'string',
            ...
            'filesystems.links.C:\wamp64\www\my-project\public\storage' => 'string',
...
'auth.guards.web.provider','auth.guards.admin.driver','auth.guards.admin.provider','auth.guards.customer.driver','auth.guards.customer.provider',
'auth.guards.admin_api.driver','auth.guards.admin_api.provider','auth.guards.customer_api.driver','auth.guards.customer_api.provider','auth.guards.sanctum.driver',
...
'filesystems.links.C:\\wamp64\\www\\my-project\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'signed','throttle','verified','admin.auth','customer.auth',
'admin.api','customer.api',);
        registerArgumentsSet('routes', 
'sanctum.csrf-cookie','admin.login','admin.login.submit','admin.logout',
'admin.dashboard','admin.categories.index','admin.categories.create','admin.categories.edit','admin.brands.index',
'admin.brands.create','admin.brands.edit','admin.products.index','admin.products.create','admin.products.edit',
'admin.products.attributes','admin.products.specifications','admin.products.tags','admin.products.variants','admin.orders.index',
'admin.orders.view','admin.media.index','admin.media.upload','admin.offers.index','admin.offers.create',
'admin.offers.edit','admin.taxes.index','admin.taxes.create','admin.taxes.edit','admin.users.index',
'admin.users.create','admin.users.edit','admin.inventory.index','admin.inventory.history','admin.inventory.update',
'admin.notifications.index','admin.crm.index','admin.crm.popup','admin.crm.settings','admin.reports.index',
'admin.reports.sales','admin.reports.customers','admin.reports.products','admin.shipping.index','admin.shipping.charges',
'admin.settings.index','customer.home.index','customer.login','customer.register','customer.forgot-password',
'customer.products.list','customer.category.products','customer.products.details','customer.products.search','customer.cart',
'customer.checkout','customer.checkout.payment','customer.checkout.confirmation','customer.wishlist','customer.page.about',
'customer.page.contact','customer.page.faq','customer.page.terms','customer.page.privacy','customer.page.shipping-policy',
'customer.page.size-guide','customer.account.profile','customer.account.orders','customer.account.orders.details','customer.account.addresses',
'customer.account.change-password','customer.error.404','storage.local',);
        registerArgumentsSet('views', 
'admin.auth.forgot-password','admin.auth.login','admin.auth.register','admin.brands.create','admin.brands.edit',
'admin.brands.index','admin.categories.create','admin.categories.edit','admin.categories.index','admin.crm.index',
'admin.crm.popup','admin.crm.settings','admin.dashboard.index','admin.inventory.history','admin.inventory.index',
'admin.inventory.update','admin.layouts.auth','admin.layouts.master','admin.layouts.modal','admin.media.index',
'admin.notifications.index','admin.offers.create','admin.offers.edit','admin.offers.index','admin.orders.index',
'admin.orders.view','admin.partials.footer','admin.partials.header','admin.partials.scripts','admin.partials.sidebar',
'admin.partials.topbar','admin.products.attributes','admin.products.create','admin.products.edit','admin.products.index',
'admin.products.specifications','admin.products.tags','admin.reports.customers','admin.reports.index','admin.reports.products',
'admin.reports.sales','admin.settings.index','admin.shipping.charges','admin.shipping.index','admin.taxes.create',
'admin.taxes.edit','admin.taxes.index','admin.users.create','admin.users.edit','admin.users.index',
'customer.account.addresses','customer.account.change-password','customer.account.order-details','customer.account.orders','customer.account.profile',
'customer.auth.forgot-password','customer.auth.login','customer.auth.register','customer.cart.index','customer.checkout.confirmation',
'customer.checkout.index','customer.checkout.payment','customer.errors.404','customer.errors.500','customer.home.index',
'customer.layouts.auth','customer.layouts.master','customer.layouts.minimal','customer.pages.about','customer.pages.contact',
'customer.pages.faq','customer.pages.privacy-policy','customer.pages.shipping-policy','customer.pages.size-guide','customer.pages.terms',
'customer.partials.footer','customer.partials.header','customer.partials.mobile-menu','customer.partials.navbar','customer.partials.scripts',
'customer.products.category','customer.products.details','customer.products.listing','customer.products.search','customer.wishlist.index',
'vendor.media-library.image','vendor.media-library.placeholderSvg','vendor.media-library.responsiveImage','vendor.media-library.responsiveImageWithPlaceholder','welcome',
...
'C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum',
'C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array',
'C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file',
'C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in',
'C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4',
'C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array',
'C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file',
'C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file',
'C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes',
'C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits',
'C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all',
'C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters',
'C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present',
'C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited',
'C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits',
'C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted',
'C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without',
'C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric',
'C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique',
'C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid',
'C:.wamp64.www.my-project.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
