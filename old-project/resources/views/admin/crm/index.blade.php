@php
/**
 * Home Page Manager (CRM)
 * 
 * Purpose: Drag-and-drop interface for managing home page content sections and hero carousels.
 * 
 * Data Flow: 
 * - Logic: Direct content editing for banners and product grids.
 * - UX: Drag-and-drop reordering for site sections.
 * 
 * Database: 
 * - Interacts with `home_sections`, `banners`, and `hero_slides` (or specific JSON config in settings).
 * 
 * Dependencies: SortableJS, FontAwesome, SweetAlert2, Toastr, Media Picker.
 */
@endphp
