 ...
 * 
 * Purpose: Visualizes business performance, sales trends, and operational status.
 * 
 * Data Flow: 
 * - Statistics: Passed from `DashboardController` via `$stats` array.
 * - Real-time Data: Fetches category/cart data asynchronously via Fetch API for charts.
 * - Visuals: Uses Chart.js for rendering dynamic Revenue and Order Distribution graphs.
 * 
 * Database: 
 * - Aggregates data from `orders`, `products`, `customers`, and `categories`.
 * 
 * Dependencies: Chart.js, FontAwesome, Admin Master Layout.
 */
@endphp
