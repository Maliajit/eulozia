 ...
 * 
 * Purpose: Monitor stock levels across all products and variants with quick update capabilities.
 * 
 * Data Flow: 
 * - Output: Paginated inventory data via `InventoryController`.
 * - Updates: Localized stock adjustments (Add/Remove/Set) via AJAX modals.
 * 
 * Database: 
 * - `product_variants`: Primary stock source.
 * - `products`: Base product info and images.
 * 
