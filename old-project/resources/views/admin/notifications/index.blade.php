 ...
 * 
 * Purpose: Central hub for system and order-related notifications.
 * 
 * Data Flow: 
 * - Output: Displays system-wide and user-specific notifications.
 * - Processing: AJAX-based marking as read and clearing functionality.
 * 
 * Database: 
 * - `notifications`: Laravel's standard notification storage.
 * 
 * Dependencies: jQuery, SweetAlert2, Toastr, FontAwesome.
 */
@endphp
