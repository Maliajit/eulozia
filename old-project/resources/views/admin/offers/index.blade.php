@php
/**
 * Advanced Offers & Promotions Engine
 * 
 * Purpose: Detailed management of discount codes, auto-apply offers, and tiered promotions.
 * 
 * Data Flow: 
 * - Display: High-performance data grid via Tabulator with CSV/Excel export.
 * - Logic: Multi-step forms for complex offer configurations (Percentage, Fixed, BOGO).
 * - Stats: Real-time calculation of active/expired offers.
 * 
 * Database: 
 * - `offers`: Core promotion data.
 * - `offer_categories`, `offer_products`: Related constraints.
 * 
 * Dependencies: Tabulator, Axios, SweetAlert2, Toastr, FontAwesome.
 */
@endphp
