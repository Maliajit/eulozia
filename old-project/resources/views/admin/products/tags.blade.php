 ...
 * 
 * Purpose: Manage keywords/labels for product categorization and featured highlights.
 * 
 * Data Flow: 
 * - Display: Two-column layout with a live-updating tag grid and a dynamic creation form.
 * - Actions: Slug auto-generation, status toggling, and featured marking via AJAX.
 * 
 * Database: 
 * - `tags`: Metadata for product labels.
 * 
