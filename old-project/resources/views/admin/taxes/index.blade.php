 ...
 * 
 * Purpose: Configure tax rates, classes, and rules for orders based on location.
 * 
 * Data Flow: 
 * - Display: Two-tab interface for Rates and Classes using Tabulator.
 * - Tools: Integrated tax calculator for verification.
 * 
 * Database: 
 * - `tax_rates`, `tax_classes`: Storage for tax logic.
 * 
