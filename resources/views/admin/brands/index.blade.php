 ...
 * 
 * Purpose: Manage product brands/manufacturers and their metadata.
 * 
 * Data Flow: 
 * - Display: Dynamic list rendered via Tabulator.
 * - Persistence: AJAX-based save/update of brand details including logo uploads.
 * - Statistics: Real-time calculation of brand performance/counts.
 * 
 * Database: 
 * - `brands`: Primary storage for manufacturer data.
 * 
 * Dependencies: Tabulator, Axios, Swal2, File Upload logic.
 */
@endphp
