                            ...
                            <div class="w-full">
                                ...
                                <div class="mb-6 flex flex-col md:flex-row justify-between items-center gap-4">
                                    ...
                                    <div class="flex items-center space-x-2 w-full md:w-auto">
                                        <label
                                            class="cursor-pointer bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-lg shadow transition flex items-center justify-center w-full md:w-auto">
                ...
                <div
                    ...
                    <div class="bg-white px-6 pb-4 pt-5 sm:p-6 sm:pb-4">
                        <div class="sm:flex sm:items-start">
                            ...
                            <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                ...
                                <div class="mt-2">
                                    <p class="text-sm text-gray-500" id="deleteMessage">Are you sure you want to delete this
                                        category? This action cannot be undone.</p>
                    ...
                    <div class="bg-gray-50 px-6 py-4 sm:flex sm:flex-row-reverse sm:px-6">
                        <button type="button" onclick="confirmDelete()"
                            class="btn-primary bg-rose-600 hover:bg-rose-700 ml-3">
                            <i class="fas fa-trash mr-2"></i>Delete
                        </button>
