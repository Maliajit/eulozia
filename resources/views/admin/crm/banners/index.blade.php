 ...
 * 
 * Purpose: Manage hero slider banners and promotional images for the storefront.
 * 
 * Data Flow: 
 * - Output: Visual grid of active and inactive banners.
 * - Processing: CRUD operations for banner titles, images, and sort orders.
 * 
 * Database: 
 * - `banners`: Stores banner content and visibility status.
 * 
 * Dependencies: FontAwesome, Admin Master Layout.
 */
@endphp
