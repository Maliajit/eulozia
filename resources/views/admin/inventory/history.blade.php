 ...
 * 
 * Purpose: Audit log for all manual and automated stock changes.
 * 
 * Data Flow: 
 * - Output: Filterable list of stock transactions via `InventoryController@getHistory`.
 * - Logic: Displays old vs new stock and the user responsible for the change.
 * 
 * Database: 
 * - `inventory_logs` (or similar): Tracks the transaction history.
 * 
 * Dependencies: Tabulator, Axios, SweetAlert2, FontAwesome.
 */
@endphp
