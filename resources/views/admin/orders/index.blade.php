 ...
 * 
 * Purpose: Centralized interface for tracking, filtering, and managing customer orders.
 * 
 * Data Flow: 
 * - Output: Paginated order data via `OrderController@getOrders`.
 * - Persistence: POST requests to update Status, Payment, or Tracking info via AJAX.
 * - Exports: Supports CSV/Excel generation for order records.
 * 
 * Database: 
 * - `orders`: Primary source.
 * - `users`: Linked customer data.
 * - `order_items`: Counted for summary display.
 * 
 * Dependencies: FontAwesome, SweetAlert2, Toastr, Admin Master Layout.
 */
@endphp
