 ...
 * 
 * Purpose: Comprehensive breakdown of a specific order including items, customer, shipping, and payment logs.
 * 
 * Data Flow: 
 * - Output: Unified `$order` object with eager-loaded relations (items, customer, shipments).
 * - Updates: Localized status/payment updates via AJAX modals.
 * 
 * Database: 
 * - Reads from `orders`, `order_items`, `users`, `shipments`, and `payment_methods`.
 * 
 * Dependencies: SweetAlert2 (for status updates), Admin Master Layout.
 */
@endphp
