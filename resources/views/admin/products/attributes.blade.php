 ...
 * 
 * Purpose: Manage global product attributes (Color, Size, Material) and their corresponding values.
 * 
 * Data Flow: 
 * - Output: High-performance data grid via Tabulator with pagination and filters.
 * - Processing: AJAX-driven CRUD for attributes and nested values.
 * - Integration: Provides options for the product variant generator in the Product Edit view.
 * 
 * Database: 
 * - `attributes`: Stores attribute definitions.
 * - `attribute_values`: Stores individual options for each attribute.
 * 
