 ...
 * 
 * Purpose: Provides a searchable and filterable list of all products in the store.
 * 
 * Data Flow: 
 * - Output: Paginated list of products via `ProductController`.
 * - Input: Search query (name/SKU) and status filters via GET request.
 * 
 * Database: 
 * - `products`: Source of catalog data.
 * - `tax_classes`: Joined for tax labeling.
 * 
 * Dependencies: Admin Master Layout, Tailwind CSS.
 */
@endphp
