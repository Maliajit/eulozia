 ...
 * 
 * Purpose: Manage technical specifications, groups, and values for detailed product descriptions.
 * 
 * Data Flow: 
 * - Display: Three-tab interface (Specs, Groups, Values) using Tabulator for data management.
 * - Processing: Dynamic loading of values based on selected specification; AJAX persistence for all entities.
 * 
 * Database: 
 * - `specifications`: Individual spec definitions.
 * - `specification_groups`: Collections of related specs.
 * - `specification_values`: Predefined value options.
 * 
 * Dependencies: Tabulator, Axios, Toastr, SweetAlert2, FontAwesome.
 */
@endphp
