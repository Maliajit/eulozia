 ...
 * 
 * Purpose: Unified high-level view of store performance, revenue, and customer trends.
 * 
 * Data Flow: 
 * - Output: KPI counters, growth percentages, and trend chart placeholders.
 * - Actions: Shortcuts to deep-dive reports (Sales, Products, Customers).
 * 
 * Database: 
 * - Aggregates data from `orders`, `users`, and `product_variants`.
 * 
 * Dependencies: FontAwesome, SweetAlert2, Chart.js (implied for trends).
 */
@endphp
