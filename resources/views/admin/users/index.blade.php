 ...
 * 
 * Purpose: Manage customer profiles, account status (active/blocked), and view purchase history.
 * 
 * Data Flow: 
 * - Listing: Fetches customer data via `UserController@getUsers`.
 * - Operations: CRUD operations for customer accounts; supports bulk actions and exports.
 * 
 * Database: 
 * - `users`: Primary table (specifically where role is 'customer' or determined by context).
 * - `orders`: Aggregated for 'orders_count' and 'total_spent'.
 * 
 * Dependencies: FontAwesome, SweetAlert2, Toastr.
 */
@endphp
