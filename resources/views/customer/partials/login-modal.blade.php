...
<div id="loginModal" class="fixed inset-0 z-50 hidden flex items-center justify-center p-4 bg-black bg-opacity-50">
    <div class="bg-primary rounded-lg max-w-md w-full mx-auto transform transition-all duration-300 scale-95 opacity-0"
        ...
        <div class="p-6">
            ...
            <!-- Login Form -->
            <form id="loginForm" method="POST" action="{{ route('customer.login') }}" class="space-y-4">
                @csrf
                <div>
                ...
                <div class="flex items-center justify-between">
                    <label class="flex items-center">
                        <input type="checkbox" name="remember" class="rounded bg-gray-800 border-gray-700 text-accent focus:ring-accent">
            ...
            <div class="mt-6 text-center">
                <p class="text-accent">
                    New to our store? 
                    <button onclick="closeLoginModal(); openSignupModal();" class="text-secondary font-semibold hover:text-accent transition-colors duration-300">
                        Create an account
                    </button>
                </p>
            </div>
