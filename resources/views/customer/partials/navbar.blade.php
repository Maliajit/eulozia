<nav class="bg-black text-white py-4">
    <div class="container mx-auto px-6 flex justify-between items-center">
        <a href="{{ route('customer.home') }}" class="text-2xl font-bold tracking-tighter">EULOZIA</a>
        <div class="hidden md:flex space-x-8">
            <a href="{{ route('customer.products.index') }}" class="hover:text-accent transition-colors">SHOP ALL</a>
        ...
        <div class="flex items-center space-x-6">
            ...
            <a href="{{ route('customer.account.index') }}" class="hover:text-accent transition-colors"><i
