...
<div id="signupModal" class="fixed inset-0 z-50 hidden flex items-center justify-center p-4 bg-black bg-opacity-50">
    <div class="bg-primary rounded-lg max-w-md w-full mx-auto transform transition-all duration-300 scale-95 opacity-0"
        ...
        <div class="p-6">
            ...
            <!-- Signup Form -->
            <form id="signupForm" method="POST" action="{{ route('customer.register') }}" class="space-y-4">
                @csrf
                <div>
            ...
            <div class="mt-6 text-center">
                <p class="text-accent">
                    ...
                    <button onclick="closeSignupModal(); openLoginModal();" class="text-secondary font-semibold hover:text-accent transition-colors duration-300">
                        Login here
                    </button>
                </p>
            </div>
